        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <div class="card-header border-bottom col-5">
                <h5 class="card-title">{{ __('admin.cities') }}</h5>
              ...
              <div class="card-datatable table-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (Auth::guard('admin')->user()->hasPermission('city-update'))
                                        <a class="btn btn-sm btn-icon" href="{{ route("city.edit",$item->id) }}"><i class="bx bx-edit"></i></a>
                                    @endif
                ...
                @php
                    ...
                    if(isset($data['search'] )){
                        $appendsArray['search'] = $data['search'];
                    }
                @endphp
                @if(sizeof($appendsArray) > 0)
                    {{$cities->appends($appendsArray)->links()}}
                @else
                    {{$cities->links()}}
                @endif
              </div>
