        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <div class="card-header border-bottom">
                <h5 class="card-title">{{ __('admin.categories') }}</h5>
                  ...
                  <tbody>
                    @if(count($categories) > 0)
                        @foreach ($categories as $index=>$item )
                            <tr>
                                <td >{{ $index+1 }}</td>
                                <td > <img src="{{ asset("$item->icon") }}"  style=" width: 67px; height: 67px;"></td>
                                ...
                                @endforeach --}}
                                <td>
                                    @if (Auth::guard('admin')->user()->hasPermission('category-update'))
                                        <a class="btn btn-sm btn-icon" href="{{ route("category.edit",$item->id) }}"><i class="bx bx-edit"></i></a>
                                    @endif
                                    @if (Auth::guard('admin')->user()->hasPermission('category-delete'))
