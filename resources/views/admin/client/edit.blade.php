...
@section('content')
    ...
    <!-- Content -->
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><span><a href="{{ route('client.index') }}"> {{ __('admin.clients') }} </a>  </span> / {{ $client->username }} / {{ __('admin.edit') }}</h4>
            <div class="row mb-4">
                <div class="row">
                    <div class="card mb-4">
                        <h5 class="card-header">{{ __('admin.edit') }}</h5>
                        @include('admin.includes._errors')
                        <form class="card-body" action="{{ route('client.update',$client->id) }}" method="post">
                            @csrf
                            @method('put')
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col mt-2">
                              <div class="form-check form-check-inline">
                                <input  name="gender" @if($client->gender == 'male') checked @endif  class="form-check-input"  type="radio"  value="meal"  id="collapsible-address-type-home"  checked="" />
