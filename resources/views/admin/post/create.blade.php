...
@section('content')
    ...
    <!-- Content -->
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('post.index') }}"> {{ __('admin.posts') }} </a> / </span> {{ __('admin.add') }}</h4>
            <div class="row mb-4">
                <div class="row">
                    <div class="card mb-4">
                            ...
                            <div class="row g-3">
                                @foreach (config('translatable.locales') as $lang)
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="title:{{ $lang }}" id="multicol-title" class="form-control"  />
                                    </div>
                                @endforeach
                            </div>
