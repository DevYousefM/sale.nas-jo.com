...
$searchPriceRange.slider({
    ...
    slide: function( event, ui ) {
        $searchPriceRange.find('.ui-slider-handle:eq(0)').html( '<span>' + '$' + ui.values[ 0 ] + '</span><input hidden name="min_price" value="'+ $searchPriceRange.slider( "values", 0 )+'" > ');
        $searchPriceRange.find('.ui-slider-handle:eq(1)').html( '<span>' + '$' + ui.values[ 1 ] + '</span><input hidden name="max_price" value="'+ $searchPriceRange.slider( "values", 1 )+'" > ');
    }
});
$searchPriceRange.find('.ui-slider-handle:eq(0)').html( '<span>' + '$' + $searchPriceRange.slider( "values", 0 ) + '</span><input hidden name="min_price" value="'+ $searchPriceRange.slider( "values", 0 )+'" > ' );
$searchPriceRange.find('.ui-slider-handle:eq(1)').html( '<span>' + '$' + $searchPriceRange.slider( "values", 1 ) + '</span><input hidden name="max_price" value="'+ $searchPriceRange.slider( "values", 1 )+'" > ' );
